'''
Alguns comandos que foir passado durante a aula:
(Copiados do Github do Dennis)

1 - python manage.py shell
2 - from acoounts.models import *
3 - ex : customers = Customer.objects.all()
4 - ex : print(customers),  print(customers.last()) ...
